...
If the user has provided product/marketing context, use it before asking questions. Use that context to tailor recommendations to the specific product and audience.
...
- **mk-page-cro**: Apply psychology to page optimization
- **mk-copywriting**: Write copy using psychological principles
- **mk-popup-cro**: Use triggers and psychology in popups
- **mk-pricing-page-optimization**: See mk-page-cro for pricing psychology
- **mk-ab-test-setup**: Test psychological hypotheses
