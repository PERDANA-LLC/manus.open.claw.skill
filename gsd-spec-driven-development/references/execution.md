...
This document provides detailed guidance for the execution phase of GSD.

## Table of Contents

1. [Execution Flow](#execution-flow)
2. [Deviation Rules](#deviation-rules)
3. [Checkpoint Protocol](#checkpoint-protocol)
4. [Authentication Gates](#authentication-gates)
5. [Commit Protocol](#commit-protocol)
6. [SUMMARY.md Format](#summarymd-format)
...
Before any operation, read project state from `.planning/STATE.md`.
...
**If file missing but .planning/ exists:** Reconstruct from existing artifacts.
...
- Check completed tasks in prompt
...
- Atomic, traceable, revertable

---

## SUMMARY.md Format

After plan completion, create `.planning/phases/{N}/{plan}-SUMMARY.md`:
